...
public class Helper {
    ...
    public static void main(String[] args) throws IOException{
        ...
        BufferedReader pr = new BufferedReader(new FileReader("pr30.txt"));
        BufferedReader transition = new BufferedReader(new FileReader("transition.txt"));
        FileWriter fileWriter = new FileWriter("result_30_0.5.csv");
